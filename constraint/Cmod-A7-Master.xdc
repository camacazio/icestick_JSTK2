...
## LEDs
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports {LED[4]}]
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports CS]
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33} [get_ports SDIN]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { ja[2] }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports SCLK]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports DC]
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports RES]
set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports VBAT]
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports VDD]
...
#set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { JSTK_SS }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
#set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { JSTK_MOSI }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
#set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { JSTK_MISO }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
#set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { JSTK_SCK }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
set_property -dict {PACKAGE_PIN R3 IOSTANDARD LVCMOS33} [get_ports JSTK_SCK]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports JSTK_MISO]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports JSTK_MOSI]
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports JSTK_SS]
